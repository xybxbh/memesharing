...
public class ShowEmojisofMaterialTask extends AsyncTask<String, Void, List<Emoji>> {
    ...
    public ShowEmojisofMaterialTask(Context context,GridView gridMaterialMainpage) {
        this.gridMaterialMainpage = gridMaterialMainpage;
        this.context = context;
    }
    @Override
    protected List<Emoji> doInBackground(String... arg0) {
        String url = "http://139.199.158.77:8080/Emoji/ShowEmojisofMaterialServlet";
        HttpClient client = new DefaultHttpClient();
        HttpPost request = new HttpPost(url);

        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("materialid", arg0[0]));
    ...
    protected void onPostExecute(List<Emoji> result) {
        ...
        if(result!=null){
            ...
            gridMaterialMainpage.setAdapter(adapter);
            gridMaterialMainpage
            ...
            gridMaterialMainpage.setVisibility(View.VISIBLE);}
        else
        {
