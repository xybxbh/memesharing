...
public class ShowEmojiphotoTask extends AsyncTask<String, Void, List<Emoji>> {

    private GridView gridEmoji;
    private Context context;
    String emojiListGson;

    public ShowEmojiphotoTask(Context context, GridView gridEmoji) {
        this.gridEmoji = gridEmoji;
        this.context = context;
    }
    @Override
    protected List<Emoji> doInBackground(String... arg0) {
        String url = "http://139.199.158.77:8080/Emoji/ShowAllEmojiServlet";
    ...
    protected void onPostExecute(List<Emoji> result) {
        ...
        if(result!=null){
            ...
            gridEmoji.setVisibility(View.VISIBLE);}
        else
        {
